/**
 * Formats a number of bytes into a human-readable string (e.g., "50MB").
 */
...
export const HOSTING_CONFIG_KEY = 'planlyai_hosting_config';
export const HOSTING_DOMAIN_SUFFIX = '.puter.site';

export const createHostingSlug = () => `planly-${Date.now().toString(36)}-${Math
